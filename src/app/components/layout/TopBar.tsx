        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden md:block text-left">
              <div style={{ fontSize: "0.8rem", fontWeight: 600 }}>{role === "manager" ? "Alex Morgan" : "John Doe"}</div>
          ...
          {showProfile && (
            <div className="absolute right-0 top-11 w-52 rounded-2xl shadow-2xl z-50 overflow-hidden"
              ...
              <div className="px-4 py-3" style={{ borderBottom: "1px solid var(--border)" }}>
                <p style={{ fontWeight: 600, fontSize: "0.875rem" }}>{role === "manager" ? "Alex Morgan" : "John Doe"}</p>
                <p style={{ fontSize: "0.75rem", color: "var(--muted-foreground)" }}>
                  {role === "manager" ? "admin@company.com" : "john@company.com"}
                </p>
              </div>
              {[
